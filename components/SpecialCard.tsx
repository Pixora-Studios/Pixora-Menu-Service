...
export default function SpecialCard({ item }: { item: MenuItem }) {
  ...
  return (
    <motion.div
      ...
      className="group relative bg-cardBg border border-border rounded-3xl overflow-hidden flex flex-col md:flex-row min-h-[300px] transition-all duration-500 hover:border-accent/40 col-span-1 md:col-span-2"
    >
